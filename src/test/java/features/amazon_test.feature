Feature: Test add item to and edit basket at https://www.amazon.co.uk/
  ...
  Scenario Outline: Edit basket
    ...
    Examples:
      ...
      | Amazon.co.uk: Low Prices in Electronics, Books, Sports Equipment & more | Books            | Harry Potter and the Cursed Child | Amazon.co.uk Shopping Basket | Shopping Basket | Paperback | £3.99      | 1        | £3.99       |